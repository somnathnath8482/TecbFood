...
<head>
  ...
  <script src="https://easysent.in/Payment/pay.php"></script>
  <!-- Favicons-->
  ...
  <link href="js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
    ...
    <script src="js/handelOrder.js"></script>
</head>
...
?>
<form  method="post"><!-- action="routers/order-router.php" -->
<?php
$arr = [];
foreach ($_POST as $key => $value)
{
...
$jsonArr = htmlspecialchars(json_encode($arr), ENT_QUOTES, 'UTF-8');
...
<button class="btn cyan waves-effect waves-light right" type="button" name="actionss" onclick="createOrder( 
'<?php echo $name ?>',
'<?php echo $contact ?>',
'<?php echo $total ?>',
...
?>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright © 2023 <a class="grey-text text-lighten-4" href="#" target="_blank">TECB Canteen.</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">TECB Canteen.</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
