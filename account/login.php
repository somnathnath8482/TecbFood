<?php  
session_start(); 
if(false || isset($_SESSION['admin_sid']) || isset($_SESSION['customer_sid']))
{
      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Login for <b> TECB Canteen </b> Food Ordering System</p>
          </div>
        </div>
        ...
        <p><center>Copyright &copy; 2023 TECB Canteen. All Right Reserved</center></p>
        </div>
